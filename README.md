...
cd hammerdb
# YOU SHOULD CREATE A NEW BRANCH AND CHANGE THE SETTINGS IN THE NEW BRANCH
...
**You need to delete the cluster yourself(You can do that with azure/delete-resource-group.sh or from the portal). In hammerdb, we sometimes need to connect to the coordinator or driver node to get some more information.**
